          ...
          <GuideNavBar activeTab={activeTab}/>
            <div className="max-w-screen-2xl mx-auto my-[100px] flex flex-col items-center justify-center ">
              <div className="absolute top-[150px]" id="combinationSection">
                <p className="text-6xl font-COP1 font-bold text-white text-shadow-emeraldGlow">COMBINATION GUIDE</p>
              </div>
    ...
    />
            ...
            <div className="h-screen w-full bg-BG4 flex flex-col items-center justify-center " ref={serverRulesSectionRef}>
              <div className="" id="serverRulesSection">
                  <p className="mt-[100px] text-6xl font-COP1 font-bold text-white text-shadow-emeraldGlow">SERVER RULES</p>
              </div>
              ...
              <div className="overflow-x-auto w-3/4 bg-black/50 rounded-lg mt-10 mb-10 p-5">
                <table className="table text-emerald-300">
                  {/* head */}
                  <thead className="text-4xl text-white text-shadow-emeraldGlow font-bold font-COP1">
                    <tr>
                      <th></th>
                      <th>Rules</th>
                      <th>Sanction</th>
                  ...
                  <tbody className="text-xl">
                    ...
                    <tr>
                     ...
                     <tr>
                      <th>17</th>
                      <td className="text-2xl font-bold">The player is accountable for his account information and items. Giving your personal account information or gear to friends or pilots comes at your own risk. If they change your password or sell your items or account, you are responsible. It will not be recovered by the staff.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
